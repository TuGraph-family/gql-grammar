...
I_DONT_KNOW_1 : 'I_DONT_KNOW_1' ;
I_DONT_KNOW_2 : 'I_DONT_KNOW_2' ;
I_DONT_KNOW_3 : 'I_DONT_KNOW_3' ;
I_DONT_KNOW_4 : 'I_DONT_KNOW_4' ;
I_DONT_KNOW_5 : 'I_DONT_KNOW_5' ;
IF : 'IF' ;
IN : 'IN' ;
INSERT : 'INSERT' ;
INT : 'INT' ;
...
UNSIGNED_DECIMAL_IN_SCIENTIFIC_NOTATION : UNSIGNED_DECIMAL_INTEGER 'E' (PLUS_SIGN|MINUS_SIGN)? UNSIGNED_DECIMAL_INTEGER ;


UNSIGNED_DECIMAL_INTEGER : STANDARD_DIGIT ( ( UNDERSCORE )? STANDARD_DIGIT )* ;
...
FOUR_DIGIT: STANDARD_DIGIT STANDARD_DIGIT STANDARD_DIGIT STANDARD_DIGIT;
DOUBLE_DIGIT: STANDARD_DIGIT STANDARD_DIGIT;
SINGLE_QUOTED_STRING_LITERAL : QUOTE ( StringLiteral_1 )* QUOTE ;
DOUBLE_QUOTED_STRING_LITERAL : DOUBLE_QUOTE ( StringLiteral_0 )* DOUBLE_QUOTE ;
ACCENT_QUOTED_STRING_LITERAL : GRAVE_ACCENT (EscapedSymbolicName_0)*  GRAVE_ACCENT ;
//MANTISSA : EXACT_NUMERIC_LITERAL ;
//MANTISSA : UNSIGNED_INTEGER;
...
IDENTIFIER_START :  ID_Start| Pc ;
IDENTIFIER_EXTEND : ID_Continue| Sc ;
SP : ( SEPARATOR )+ -> skip ;
...
SIMPLE_COMMENT : SIMPLE_COMMENT_INTRODUCER ( SIMPLE_COMMENT_CHARACTER )* LF ;
SIMPLE_COMMENT_INTRODUCER : DOUBLE_SOLIDUS|DOUBLE_MINUS_SIGN ;
SIMPLE_COMMENT_CHARACTER : 'I_DONT_KNOW_15' ;
...
BRACKETED_COMMENT_CONTENTS : 'I_DONT_KNOW_16' ;
//NEWLINE : LF  ;
...
GQL_LANGUAGE_CHARACTER : SIMPLE_LATIN_LETTER|STANDARD_DIGIT|GQL_SPECIAL_CHARACTER ;
